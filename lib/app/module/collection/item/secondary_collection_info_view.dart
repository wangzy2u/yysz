...
///藏品头部简介信息view
class SecondaryCollectionInfoView extends StatelessWidget {
  const SecondaryCollectionInfoView(
      {super.key,
        this.collectionSerialNumber,
        this.name,
        this.commodityTypeName,
        this.commodityType,
        this.seriesName,
        this.holderBlockChainAddr,
        this.quantity,
        this.reserve});

  final String? collectionSerialNumber;
  final String? name;
  final String? commodityTypeName;
  final String? commodityType;
  final String? seriesName;
  final String? holderBlockChainAddr;
  final num? quantity;
  final num? reserve;
          ...
          children: [
                    ...
                    children: [
                      Positioned(
                        child: Container(
                          ...
                          height: 18.w,
                          child: Text(
                            commodityTypeName ?? buildCollectionType(),
            ...
            Row(
              ...
              children: [
                ...
                Text(
                  TextUtil.maskIDCard(holderBlockChainAddr),
