class MyAssetsListBean {
  MyAssetsListBean({
      num? total,
      List<AssetsListItemBean>? list,
      num? pageNum, 
      num? pageSize, 
      num? size, 
      num? startRow, 
  ...
  MyAssetsListBean.fromJson(dynamic json) {
    _total = json['total'];
    if (json['list'] != null) {
      _list = [];
      json['list'].forEach((v) {
        _list?.add(AssetsListItemBean.fromJson(v));
      });
    }
  ...
  List<AssetsListItemBean>? get list => _list;
...
class AssetsListItemBean {
  ...
  AssetsListItemBean.fromJson(dynamic json) {
    ...
    _totalCollections = json['totalCollections'];
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    map['totalCollections'] = _totalCollections;
    return map;
  }
