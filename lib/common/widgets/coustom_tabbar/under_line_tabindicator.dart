...
class CustomUnderlineTabIndicator extends Decoration {
  ...
  Rect indicatorRectFor(Rect rect, TextDirection textDirection) {
    assert(rect != null);
...
//         indicator.bottom - borderSide.width, wantWidth, borderSide.width);
  ...
  Path getClipPath(Rect rect, TextDirection textDirection) {
    return Path()..addRect(indicatorRectFor(rect, textDirection));
  }
}
...
class _UnderlinePainter extends BoxPainter {
  ...
  void paint(Canvas canvas, Offset offset, ImageConfiguration configuration) {
    ...
    final Rect indicator = decoration.indicatorRectFor(rect, textDirection).deflate(decoration.borderSide.width / 2.0);
