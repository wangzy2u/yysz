...
class VideoPlayView extends StatefulWidget {
  const VideoPlayView({super.key, required this.url, this.height});
  final String url;
  final double ? height;
  @override
    ...
    return SingleChildScrollView(
      child: Column(
        children: <Widget>[
          ...
          Container(
            height: widget.height ?? _controller.value.size.height,
      ...
      children: <Widget>[
        AnimatedSwitcher(
          ...
          child: controller.value.isPlaying
            ...
            child: Center(
              child: IconX.image('icon_play.png'.skImagePath,size: 44.w,),
            ),
          ),
        ),
        GestureDetector(
